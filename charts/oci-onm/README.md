...
![Version: 4.0.3](https://img.shields.io/badge/Version-4.0.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.0.0](https://img.shields.io/badge/AppVersion-3.0.0-informational?style=flat-square)
...
| file://../logan | oci-onm-logan | 4.0.2 |
| file://../mgmt-agent | oci-onm-mgmt-agent | 3.0.5 |
...
| global.tolerations | list | `[]` | Global tolerations applied to all pods in subcharts. Default: [] (no global tolerations) Example: tolerations:   - key: "global-taint"     operator: "Exists"     effect: "NoSchedule" |
...
| oci-onm-logan.image.url | string | `"container-registry.oracle.com/oci_observability_management/oci-la-fluentd-collector:1.7.2"` |  |
...
| oci-onm-logan.ociDomain | string | `nil` |  |
| oci-onm-logan.ociLAClusterEntityID | string | `nil` |  |
...
| oci-onm-mgmt-agent.mgmtagent.image.url | string | `"container-registry.oracle.com/oci_observability_management/oci-management-agent:1.9.0"` |  |
