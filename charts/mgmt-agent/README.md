...
| mgmtagent.tolerations | list | `[]` | Custom tolerations to apply to the mgmtagent pod in the chart. Default: [] (no additional tolerations) Example: tolerations:   - key: "example-taint"     operator: "Exists"     effect: "NoSchedule" |
