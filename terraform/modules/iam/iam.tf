...
locals {
  custer_ocid_md5 = md5(var.oke_cluster_ocid)

  # Dynmaic Group
  dynamic_group_name            = "oci-kubernetes-monitoring-${local.custer_ocid_md5}"
  ...
  # Policy
  policy_name          = "oci-kubernetes-monitoring-${local.custer_ocid_md5}"
