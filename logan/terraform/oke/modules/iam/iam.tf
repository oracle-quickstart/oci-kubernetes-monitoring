locals {
  ...
  dynamic_group_desc            = "Auto-Generated by Resource Manager. Required for monitoring OKE Cluster - ${var.oke_cluster_ocid}, in ${local.oke_compartment_name} compartment."
