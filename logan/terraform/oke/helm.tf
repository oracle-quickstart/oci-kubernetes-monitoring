locals {
  ...
  final_oci_la_logGroup_id = !var.opt_use_existing_la_logGroup && var.enable_la_resources ? oci_log_analytics_log_analytics_log_group.new_log_group[0].id : var.oci_la_logGroup_id
}
